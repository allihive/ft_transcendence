...
class MatchmakingController {
    constructor() {
        this.matchmakingService = new matchmaking_service_1.MatchmakingService();
    }
    /**
     ...
     * }
     */
    async getQueueStatus(request, reply) {
        try {
     ...
     * }
     */
    async completeMatch(request, reply) {
        try {
            const body = request.body;
