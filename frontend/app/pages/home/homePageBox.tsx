...
function BlueBox() {
	...
	// const handleGoogleClick = () => googleclick; timmo's popup here
	...
	return (
		...
		{showLogin ? (
			<div className="flex flex-col justify-center items-center mt-10 font-title">
				...
				{/* <button onClick={handleGoogleClick} className="border-2 border-black rounded-lg mt-4">Sign in with Google</button> */}
