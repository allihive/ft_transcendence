...
import type { CredentialsFormData, CredentialsFormProps, CredentialsFormValues, UserLoginFormProps } from "./types";
...
export function CredentialsForm(props: CredentialsFormProps): JSX.Element {
	...
	const onSubmit: SubmitHandler<CredentialsFormValues> = async (data, event) => {
		const formData: CredentialsFormData = {
			email: data.email,
			password: data.password
		};

		props.onSumit(formData, event as FormEvent<HTMLFormElement>);
	};
