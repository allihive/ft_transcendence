...
const getErrorMessage = (statusCode: number): string => {
	switch (statusCode) {
		case 400:
			return "There was an issue with the request. Please make sure everything is correct and try again.";
		case 401:
			return "You're not authorized to view this page.";
		case 403:
			return "Access is denied. Please reach out to support for assistance.";
		case 404:
			return "The page or resource you're looking for doesn't exist";
		case 405:
			return "This action isn't allowed.";
		case 408:
			return "Your request took too long to process.";
		case 429:
			return "You've made too many requests. Please wait a moment and try again.";
		case 503:
			return "The service is currently unavailable.";
		case 504:
			return "It's taking longer than usual to respond.";
		default:
